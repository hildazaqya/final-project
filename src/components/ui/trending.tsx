...
export default function TrendingNow() {
  ...
  return (
    <div className="flex flex-col justify-center items-center z-10 mt-5">
      <div className="title flex justify-start items-center w-full ms-5 z-10">
        <h3 className="text-2xl font-bold text-white text-left ms-10">
          Trending Now
        </h3>
      </div>
      <div className="relative flex flex-row gap-5 z-10 items-center justify-center !w-[1000px] mx-[50px] mt-4">
