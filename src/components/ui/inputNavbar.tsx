    ...
    return (
        <div className='input hidden lg:block'>
            <label className="relative flex items-center w-[250px] h-[30px] my-3">
                ...
                <input className="w-full bg-secondary rounded-xl py-2 pl-10 pr-4 focus:outline-none text-sm text-accent focus:text-accent" placeholder="Search anything" type="text"
                    value={keyword}
                    onChange={(e) => setKeyword(e.target.value)}
                    onClick={fetchMovies} />
                {
                    showDropdown && searchResults.length > 0 && (
                        <div className="search-popup absolute bg-secondary border-milky rounded-lg mt-3 w-full max-w-[300px] h-[300px] top-[30px] overflow-y-auto shadow-lg z-50">
